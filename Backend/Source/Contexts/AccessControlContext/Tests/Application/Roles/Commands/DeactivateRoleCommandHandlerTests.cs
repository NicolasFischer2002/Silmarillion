...
public class DeactivateRoleCommandHandlerTests
{
    ...
    public async Task HandleAsync_ShouldReturnFailure_WhenRoleDoesNotExist()
    {
        ...
        var handler = new DeactivateRoleCommandHandler(
    ...
    [TestMethod]
    public async Task HandleAsync_ShouldReturnFailure_WhenRoleIsAlreadyInactive()
    {
        var roleRepositoryMock = new Mock<IRoleRepository>();
        ...
        var command = new DeactivateRoleCommand(role.Id);
        ...
        result.ShouldFailWith(
            RoleErrors.RoleAlreadyInactive());
    ...
    [TestMethod]
    public async Task HandleAsync_ShouldDeactivateRole_WhenRoleIsActive()
    {
        var roleRepositoryMock = new Mock<IRoleRepository>();
